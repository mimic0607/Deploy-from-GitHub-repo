  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        {/* Header */}
        <header className="glass-card p-4 sticky top-0 z-10 shadow-md border-b border-purple-primary/20">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button className="p-2 rounded-full hover:bg-purple-primary/20 transition-fade">
                <Bell className="h-5 w-5 text-purple-primary" />
              </button>
              <button className="p-2 rounded-full hover:bg-purple-primary/20 transition-fade">
                <HelpCircle className="h-5 w-5 text-purple-primary" />
              </button>

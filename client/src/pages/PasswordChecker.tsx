    ...
    <AppLayout title="Password Checker">
      <div className="max-w-3xl mx-auto">
        <PageTitle 
          ...
          subtitle="Analyze and enhance your password security"
        ...
        <div className="glass-card rounded-2xl p-6 mt-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              <div className="h-8 w-8 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-500 mr-3 mt-1">
                1
              </div>
              <div>
